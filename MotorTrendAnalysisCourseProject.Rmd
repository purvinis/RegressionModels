...
```
The best model is fit5. The model becomes: mpg = 26.585 + 5.2771am + -0.058888hp.The model means that mpg will increase by 5.2771 when going from automatic to manual transmission, for a given (constant) hp.
